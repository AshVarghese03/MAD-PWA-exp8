...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Routing', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w700),),backgroundColor: Colors.greenAccent,),
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                myInput(controler: start, hint: 'Enter Start location'),
                SizedBox(height: 15,),
                myInput(controler: end, hint: 'Enter End location'),
                SizedBox(height: 15,),
                ElevatedButton(
                    ...
                    MapOptions(
                      ...
                      children: [
                        ...
                        PolylineLayer(
                          ...
                          polylines: [
                            Polyline(points: routpoints, color: Colors.yellowAccent, strokeWidth: 9)
                          ],
                        )
                      ],
                    ),
